...
func (*HelloRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_dce1f07eff99a1fc, []int{0}
}
...
func (*HelloReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_dce1f07eff99a1fc, []int{1}
}
...
func init() { proto.RegisterFile("api.proto", fileDescriptor_api_dce1f07eff99a1fc) }

var fileDescriptor_api_dce1f07eff99a1fc = []byte{
